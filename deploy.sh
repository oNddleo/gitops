...
if [ "$CREATE_SECRETS" = "y" ]; then
    ...
    print_info "See docs/GETTING_STARTED.md for all secret creation commands."
else
...
echo "  4. Read docs/GETTING_STARTED.md for detailed verification steps"
echo ""
...
echo ""
echo "📖 Documentation:"
echo "  - docs/GETTING_STARTED.md - Full deployment & configuration guide"
echo "  - docs/DEVELOPMENT.md     - Development workflow & adding services"
